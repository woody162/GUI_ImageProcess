...
# Form implementation generated from reading ui file 'C:\Users\s9801\Desktop\code\python\opencv\ImageProcess\day30.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_open_file.setGeometry(QtCore.QRect(30, 954, 89, 41))
        self.btn_open_file.setObjectName("btn_open_file")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(80, 40, 1131, 761))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1127, 757))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.label_img = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.label_img.setGeometry(QtCore.QRect(0, 0, 1131, 761))
        ...
        self.Logo.setText("")
        self.Logo.setPixmap(QtGui.QPixmap("C:\\Users\\s9801\\Desktop\\code\\python\\opencv\\ImageProcess\\demo_materials/wongwong.png"))
        self.Logo.setScaledContents(True)
        self.Logo.setObjectName("Logo")
        self.label_filepath = QtWidgets.QLabel(self.centralwidget)
        self.label_filepath.setGeometry(QtCore.QRect(140, 930, 851, 81))
        font = QtGui.QFont()
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(1270, 80, 511, 141))
        ...
        self.label_lightness.setFont(font)
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(1270, 280, 511, 181))
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_Rvalue.setFont(font)
        self.label_Rvalue.setStyleSheet("color:rgb(255, 255, 255);")
        self.label_Rvalue.setObjectName("label_Rvalue")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_Rvalue)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.slider_Rvalue)
        self.label_Gvalue = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_Gvalue.setFont(font)
        self.label_Gvalue.setStyleSheet("color:rgb(255, 255, 255);")
        self.label_Gvalue.setObjectName("label_Gvalue")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_Gvalue)
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.slider_Gvalue)
        ...
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_Bvalue)
        ...
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.slider_Bvalue)
        ...
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_warm)
        ...
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.slider_warm)
        ...
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_cold)
        ...
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.slider_cold)
        self.verticalLayout_4.addLayout(self.formLayout_4)
        self.Background = QtWidgets.QLabel(self.centralwidget)
        self.Background.setGeometry(QtCore.QRect(0, 0, 2000, 2000))
        self.Background.setMaximumSize(QtCore.QSize(2000, 2000))
        self.Background.setAutoFillBackground(False)
        self.Background.setStyleSheet("background-color:rgb(50, 50,50); color:rgb(255, 170, 0);")
        self.Background.setText("")
        self.Background.setObjectName("Background")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(1270, 490, 431, 81))
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_zoom)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.slider_zoom)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.Zoom)
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(860, 800, 791, 141))
        self.verticalLayoutWidget_4.setObjectName("verticalLayoutWidget_4")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_4)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_click_pos = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.verticalLayout.addWidget(self.label_click_pos)
        self.label_norm_pos = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.verticalLayout.addWidget(self.label_norm_pos)
        self.label_real_pos = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.verticalLayout.addWidget(self.label_real_pos)
        self.label_img_shape = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.verticalLayout.addWidget(self.label_img_shape)
        self.RecordSteps = QtWidgets.QLabel(self.centralwidget)
        self.RecordSteps.setGeometry(QtCore.QRect(40, 810, 331, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(16)
        self.RecordSteps.setFont(font)
        self.RecordSteps.setAutoFillBackground(False)
        self.RecordSteps.setStyleSheet("color:rgb(255, 170, 0);")
        self.RecordSteps.setObjectName("RecordSteps")
        self.text_recordsteps = QtWidgets.QTextEdit(self.centralwidget)
        self.text_recordsteps.setGeometry(QtCore.QRect(370, 820, 421, 121))
        self.text_recordsteps.setObjectName("text_recordsteps")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 850, 160, 80))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.btn_redo = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.btn_redo.setObjectName("btn_redo")
        self.horizontalLayout_2.addWidget(self.btn_redo)
        self.btn_undo = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.btn_undo.setObjectName("btn_undo")
        self.horizontalLayout_2.addWidget(self.btn_undo)
        self.ColorBalance = QtWidgets.QLabel(self.centralwidget)
        self.ColorBalance.setGeometry(QtCore.QRect(1270, 240, 507, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        ...
        self.Adjustments = QtWidgets.QLabel(self.centralwidget)
        self.Adjustments.setGeometry(QtCore.QRect(1270, 40, 501, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(14)
        ...
        self.RecordSteps.raise_()
        self.text_recordsteps.raise_()
        self.horizontalLayoutWidget.raise_()
        self.ColorBalance.raise_()
        self.Adjustments.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RecordSteps.setText(_translate("MainWindow", "Record Steps"))
